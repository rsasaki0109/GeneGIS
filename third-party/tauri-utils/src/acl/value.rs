...
impl From<i8> for Value { fn from(v: i8) -> Self { Self::Number(i64::from(v).into()) } }
impl From<i16> for Value { fn from(v: i16) -> Self { Self::Number(i64::from(v).into()) } }
impl From<i32> for Value { fn from(v: i32) -> Self { Self::Number(i64::from(v).into()) } }
impl From<i64> for Value { fn from(v: i64) -> Self { Self::Number(v.into()) } }
impl From<isize> for Value { fn from(v: isize) -> Self { Self::Number(i64::try_from(v).unwrap_or(i64::MAX).into()) } }
impl From<u8> for Value { fn from(v: u8) -> Self { Self::Number(i64::from(v).into()) } }
impl From<u16> for Value { fn from(v: u16) -> Self { Self::Number(i64::from(v).into()) } }
impl From<u32> for Value { fn from(v: u32) -> Self { Self::Number(i64::from(v).into()) } }
impl From<u64> for Value { fn from(v: u64) -> Self { Self::Number(i64::try_from(v).unwrap_or(i64::MAX).into()) } }
impl From<usize> for Value { fn from(v: usize) -> Self { Self::Number(i64::try_from(v).unwrap_or(i64::MAX).into()) } }
impl From<f32> for Value { fn from(v: f32) -> Self { Self::Number(f64::from(v).into()) } }
impl From<f64> for Value { fn from(v: f64) -> Self { Self::Number(v.into()) } }

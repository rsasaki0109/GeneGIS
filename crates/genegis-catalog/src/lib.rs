...
pub use catalog::{
    ...
    nagoya_pointcloud_epoch_b_path, nagoya_pois_path, nagoya_population_mesh_path,
    nagoya_scene_copc_path, nagoya_scene_lod1_path, nagoya_shelters_path, nagoya_transit_path,
    nagoya_walk_network_path, nagoya_wards_geojson_path, nagoya_wards_geoparquet_path, repo_root,
    Catalog, EXTERNAL_STAC_DEMO_ID, LOCAL_COG_DEMO_ID, NAGOYA_FLOOD_ZONES_ID,
    NAGOYA_POPULATION_MESH_ID, NAGOYA_SHELTERS_ID, NAGOYA_TRANSIT_ID, NAGOYA_WARDS_DENSITY_ID,
    NAGOYA_WARDS_GEOPARQUET_ID, REMOTE_COG_DEMO_ID, SENTINEL_NDVI_DEMO_ID,
};
